...
function ev(e){
    if(inTouch(e)){
        if(!e.orginalEvent.touches.length) return e.orginalEvent.changeTouches;
        else return e.orginalEvent.touches;
    }else {
        return [e];
    }
}
